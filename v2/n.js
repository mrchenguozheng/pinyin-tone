export default {
    ...
    niong: ['niong', 'niōng', 'nióng', 'niǒng', 'niòng'],

    nui: ['nui', 'nuī', 'nuí', 'nuǐ', 'nuì'], //ui

    nu: ['nu', 'nū', 'nú', 'nǔ', 'nù'], // u
    nua: ['nua', 'nuā', 'nuá', 'nuǎ', 'nuà'],
    nuo: ['nuo', 'nuō', 'nuó', 'nuǒ', 'nuò'],
    nuai: ['nuai', 'nuāi', 'nuái', 'nuǎi', 'nuài'],
    nuei: ['nuei', 'nuēi', 'nuéi', 'nuěi', 'nuèi'],
    nuan: ['nuan', 'nuān', 'nuán', 'nuǎn', 'nuàn'],
    nuen: ['nuen', 'nuēn', 'nuén', 'nuěn', 'nuèn'],
    nun: ['nun', 'nūn', 'nún', 'nǔn', 'nùn'],
    nuang: ['nuang', 'nuāng', 'nuáng', 'nuǎng', 'nuàng'],
    nueng: ['nueng', 'nuēng', 'nuéng', 'nuěng', 'nuèng'],

    nv: ['nü', 'nǖ', 'nǘ', 'nǚ', 'nǜ'], // ü

    nve: ['nüe', 'nüē', 'nüé', 'nüě', 'nüè'],
    nue: ['nue', 'nuē', 'nué', 'nuě', 'nuè'],

    nvan: ['nüan', 'nüān', 'nüán', 'nüǎn', 'nüàn'],
    nvn: ['nün', 'nǖn', 'nǘn', 'nǚn', 'nǜn'],
}