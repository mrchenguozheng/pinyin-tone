module.exports = {
    ...
    liong: ['liong', 'liōng', 'lióng', 'liǒng', 'liòng'],

    lui: ['lui', 'luī', 'luí', 'luǐ', 'luì'], //ui

    lu: ['lu', 'lū', 'lú', 'lǔ', 'lù'], // u
    lua: ['lua', 'luā', 'luá', 'luǎ', 'luà'],
    luo: ['luo', 'luō', 'luó', 'luǒ', 'luò'],
    luai: ['luai', 'luāi', 'luái', 'luǎi', 'luài'],
    luei: ['luei', 'luēi', 'luéi', 'luěi', 'luèi'],
    luan: ['luan', 'luān', 'luán', 'luǎn', 'luàn'],
    luen: ['luen', 'luēn', 'luén', 'luěn', 'luèn'],
    lun: ['lun', 'lūn', 'lún', 'lǔn', 'lùn'],
    luang: ['luang', 'luāng', 'luáng', 'luǎng', 'luàng'],
    lueng: ['lueng', 'luēng', 'luéng', 'luěng', 'luèng'],

    lv: ['lü', 'lǖ', 'lǘ', 'lǚ', 'lǜ'], // ü

    lve: ['lüe', 'lüē', 'lüé', 'lüě', 'lüè'],
    lue: ['lue', 'luē', 'lué', 'luě', 'luè'],
